...
Monte Carlo](https://en.wikipedia.org/wiki/Markov_chain_Monte_Carlo).
...
If a process is reversible then it is also guaranteed to be irreducible and aperiodic. It is aperiodic because you can always  go back, and irreducible because a region cannot be entered if there is no way of returning.
